...
ax1.plot(merged_data['Date'], merged_data['Avg. Players'], color='blue', linewidth=2, label='Player Base')
ax2.plot(merged_data['Date'], merged_data['Hours_watched'], color='red', linewidth=2, linestyle='solid', label='Twitch Viewership')
...
# Labels and legend
ax1.set_xlabel('Date')
ax1.set_ylabel('Player Base', color='blue')
ax2.set_ylabel('Twitch Viewership', color='red')
ax1.set_title('Apex Legends Playerbase & Twitch Viewership with Patch Releases')
